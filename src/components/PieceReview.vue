      ...
      <h1>Information about the MusicXML file</h1>
        <div>
          ...
          <v-card-text>
            <v-row>
              <v-col cols="6">
                <v-text-field v-model="this.pieceForm.identifier" label="Identifier"></v-text-field>
              </v-col>

              <v-col cols="6">
                <v-text-field v-model="this.pieceForm.title" label="Title"></v-text-field>
              </v-col>

              <v-col cols="6">
                <v-select v-model="this.pieceForm.rights" label="Rights" :items="getItemsNameByType(1)"></v-select>
              </v-col>

              <v-col cols="6">
                <v-text-field v-model="this.pieceForm.creator" label="Creator"></v-text-field>
              </v-col>
              <v-col cols="12">
              ...
              <v-col cols="6">
                <v-select v-model="this.pieceForm.type_file" label="Type" :items="getItemsNameByType(7)"></v-select>
              </v-col>

              <v-col cols="6">
                <v-text-field v-model="this.pieceForm.publisher" label="Publisher"></v-text-field>
              </v-col>
              ...
              <v-container v-for="(c, index) in contribuidores" :key="index">
                <v-row>
                  <v-col cols="6">
                    <v-text-field v-model="c.name" label="Name or URI"></v-text-field>
                  </v-col>
                  <v-col cols="5">
                    <v-select v-model="c.role" label="Role" :items="getItemsNameByType(2)"></v-select>
                  </v-col>
                </v-row>
              </v-container>

              <v-col cols="12">
                <v-text-field v-model="this.pieceForm.desc" label="Description"></v-text-field>
              </v-col>
            </v-row>
          </v-card-text>
        </div>
        ...
        <div>
          ...
          <v-card-text>
            <v-row>
              <v-col cols="12">
                <v-select v-model="this.pieceForm.rightsp" label="Rights" :items="getItemsNameByType(1)"></v-select>
              </v-col>
              ...
              <v-container v-for="(c, index) in creadores" :key="index">
                <v-row>
                  ...
                  <v-col cols="4">
                    <v-select v-model="c.role" label="Role" :items="getItemsNameByType(3)"></v-select>
                  </v-col>
                  <v-col cols="3">
                    <v-select v-model="c.gender" label="Gender" :items="getItemsNameByType(13)"></v-select>
                  </v-col>
                </v-row>
              </v-container>
              <v-col cols="12">
