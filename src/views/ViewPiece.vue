      ...
      <v-col>
        ...
        <div>
          ...
          <v-card-text>
            <v-row>
              <v-col cols="6">
                <v-text-field v-model="id" label="Identifier" readonly :disabled="!editing"></v-text-field>
              </v-col>
              ...
              <v-col cols="6">
                <v-select v-model="right" label="Rights" :items="getItemsNameByType(1)" :disabled="!editing"></v-select>
              </v-col>

              <v-col cols="6">
                <v-text-field v-model="creator" label="Creator" :rules="rules" :disabled="!editing"></v-text-field>
              </v-col>

              <v-col cols="6">
                <v-date-picker v-model="selectedDate" @update:modelValue="formatDate" :disabled="!editing"></v-date-picker>
              </v-col>
              <v-col cols="6">
              ...
              <v-col cols="6">
                <v-select v-model="type" label="Type" :items="getItemsNameByType(7)" :rules="rules" :disabled="!editing"></v-select>
              </v-col>

              <v-col cols="6">
                <v-text-field v-model="publisher" label="Publisher" :rules="rules" :disabled="!editing"></v-text-field>
              </v-col>
              ...
              <v-col cols="6">
                <v-btn @click="addFields()" :disabled="!editing">Add contributor</v-btn>
              </v-col>
              <v-container v-for="(c, index) in contribuidores" :key="index">
                <v-row>
                  <v-col cols="6">
                    <v-text-field v-model="c.name" @input="updateContributor()" label="Name or URI" :rules="rules" hint="URI example in http://www.dib.ie"
                      persistent-hint :disabled="!editing"></v-text-field>
                  </v-col>
                  <v-col cols="5">
                    <v-select v-model="c.role" @update:modelValue="updateContributor()" label="Role" :items="getItemsNameByType(2)" :rules="rules"
                      :disabled="!editing"></v-select>
                  </v-col>
                  <v-col cols="1">
        ...
        <div>
          ...
          <v-card-text>
            <v-row>
              <v-col cols="12">
                <v-select v-model="rightsp" label="Rights" :items="getItemsNameByType(1)" :rules="rules" :disabled="!editing"></v-select>
              </v-col>
              ...
              <v-col cols="6">
                <v-btn @click="addFieldsCreators()" :disabled="!editing">Add creator</v-btn>
              </v-col>

              <v-container v-for="(c, index) in creadores" :key="index">
                <v-row>
                  <v-col cols="4">
                    <v-text-field v-model="c.name" @input="updateCreator()" label="Name or URI" :rules="rules" hint="URI example in http://www.dib.ie"
                      persistent-hint :disabled="!editing"></v-text-field>
                  </v-col>
                  <v-col cols="4">
                    <v-select v-model="c.role" @update:modelValue="updateCreator()" label="Role" :items="getItemsNameByType(3)" :rules="rules"
                      :disabled="!editing"></v-select>
                  </v-col>
                  <v-col cols="3">
                    <v-select v-model="c.gender" @update:modelValue="updateCreator()" label="Gender" :items="getItemsNameByType(13)" :disabled="!editing"></v-select>
                  </v-col>
                  <v-col cols="1">
                    <v-btn @click="removeFieldCreator(index)" :disabled="!editing">
                      <v-icon>mdi-close</v-icon>
                    </v-btn>
                  </v-col>
                </v-row>
              ...
              <v-col cols="6">
                <v-date-picker v-model="selectedDatep" @update:modelValue="formatDate" :disabled="!editing"></v-date-picker>
              </v-col>
              <v-col cols="6">
                <h2>Selected date: {{ date }}</h2>
              </v-col>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="deep-purple lighten-2" text @click="saveFields" v-if="editing">
              Save collection
            </v-btn>
