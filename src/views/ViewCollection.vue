...
Use ' = ' i.e. space equals space, where a title is available in different languages" persistent-hint :disabled="!editing"></v-text-field>
              </v-col>

              <v-col cols="6">
                <v-select v-model="right" label="Rights" :items="this.getItemsNameByType(1)" :rules="rules" :disabled="!editing"></v-select>
              </v-col>
              ...
              <v-col cols="6">
                <v-btn @click="addFieldsCreators()" v-if="editing">Add creator</v-btn>
              </v-col>

              <v-container v-for="(c,index) in creadores" :key="index">
                <v-row>
                  <v-col cols="6">
                    <v-text-field v-model="c.name" @input="updateCreator()" label="Name or URI" :rules="rules" hint="URI example in http://www.dib.ie" persistent-hint :disabled="!editing"></v-text-field>
                  </v-col>
                  <v-col cols="5">
                    <v-select v-model="c.role" @update:modelValue="updateCreator()" label="Role" :items="getItemsNameByType(5)" :rules="rules" :disabled="!editing"></v-select>
                  </v-col>
                  <v-col cols="1">
              ...
              <v-col cols="6">
                <v-btn @click="addFields()" v-if="editing">Add contributor</v-btn>
              </v-col>
              <v-container v-for="(c,index) in contribuidores" :key="index">
                <v-row>
                  <v-col cols="6">
                    <v-text-field v-model="c.name" @input="updateContributor()" label="Name or URI" hint="URI example in http://www.dib.ie" persistent-hint :disabled="!editing"></v-text-field>
                  </v-col>
                  <v-col cols="5">
                    <v-select v-model="c.role" @update:modelValue="updateContributor()" label="Role" :items="getItemsNameByType(6)" :disabled="!editing"></v-select>
                  </v-col>
                  <v-col cols="1">
              ...
              <v-col cols="6">
                <v-select v-model="type" label="Type" :items="getItemsNameByType(7)" :disabled="!editing"></v-select>
              </v-col>

              <v-col cols="6">
                <v-text-field v-model="source" label="Source" :disabled="!editing"></v-text-field>
              </v-col>

              <v-col cols="6">
                <v-text-field v-model="description" label="Description" :disabled="!editing"></v-text-field>
              </v-col>

              <v-col cols="6">
                <v-text-field v-model="format" label="Format" :disabled="!editing"></v-text-field>
              </v-col>

              <v-col cols="6">
                <v-text-field v-model="extent" label="Extent" :disabled="!editing"></v-text-field>
              </v-col>

              <v-col cols="6">
                <v-text-field v-model="publisher" label="Publisher" :disabled="!editing"></v-text-field>
              </v-col>

              <v-col cols="6">
                <v-text-field v-model="subject" label="Subject" hint="You can check the subject in https://www.vwml.org/song-subject-index. Multiple subjects must be separated by '|'" persistent-hint :disabled="!editing"></v-text-field>
              </v-col>

              <v-col cols="6">
                <v-text-field v-model="language" label="Language code" hint="You can check the code in https://www.loc.gov/standards/iso639-2/php/code_list.php" persistent-hint :disabled="!editing"></v-text-field>
              </v-col>

              <v-col cols="6">
                <v-text-field v-model="relation" label="Relation" hint=" Multiple subjects must be separated by '|'" persistent-hint :disabled="!editing"></v-text-field>
              </v-col>

              <v-col cols="6">
                <v-text-field v-model="coverage" label="Coverage" :disabled="!editing"></v-text-field>
              </v-col>
              ...
              <v-col cols="4">
                <v-text-field v-model="spatialCountry" label="Country" :disabled="!editing"></v-text-field>
              </v-col>
              <v-col cols="4">
                <v-text-field v-model="spatialState" label="State" :disabled="!editing"></v-text-field>
              </v-col>
              <v-col cols="4">
                <v-text-field v-model="spatialLocation" label="Location" :disabled="!editing"></v-text-field>
              </v-col>
              ...
              <v-col cols="4">
                <v-text-field v-model="temporalCentury" label="Century" :disabled="!editing"></v-text-field>
              </v-col>
              <v-col cols="4">
                <v-text-field v-model="temporalDecade" label="Decade" :disabled="!editing"></v-text-field>
              </v-col>
              <v-col cols="4">
                <v-text-field v-model="temporalYear" label="Year" :disabled="!editing"></v-text-field>
              </v-col>

              <v-col cols="12">
                <v-text-field v-model="rights_holder" label="rights_holder" :disabled="!editing"></v-text-field>
              </v-col>
            </v-row>
          </v-card-text>
          ...
          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="deep-purple lighten-2" text @click="saveCollection" v-if="editing">
              Save collection
            </v-btn>
            <v-btn color="deep-purple lighten-2" text @click="editFields" v-else>
              Edit fields
            </v-btn>
          </v-card-actions>
        </div>
